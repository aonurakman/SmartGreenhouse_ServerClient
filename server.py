                ...
                if msg and msg == DISCONNECT_MESSAGE:                                #mesaji aldiysan ve disconnect mesajiysa...
                    ...
                    if command !=  'X':
                        try:
                            ...
                            print("ERROR WHILE PASSING NEW VALUE TO CLIENT")
                    else:
...
def postToGreenhouse(gCode, command):
    ...
    print(greenHouses[int(gCode)-1].name + ' Clientinin sıcaklık değeri değiştirildi.')
