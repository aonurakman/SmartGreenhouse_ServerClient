...
manager = Manager()
manager.ip = "192.168.0.21"                                                         # [REPLACE]
manager.name = "manager"

greenhouseIp = ['25.65.81.190', 'xxx', 'yyy', 'zzz']                                # [REPLACE]
...
#                   print(greenHouses[idx].name + ' Clientinin Sıcaklık Değeri: ' + veri)   # ekrana gelen veriyi yazdır  
        ...
        print(e)
        print("Greenhouse ", idx+1, "has been disconnected with an error.")
        greenHouses[idx].isConnected = False
        greenHouses[idx].goal = 52
        Client.close() 
                ...
                if msg and msg == DISCONNECT_MESSAGE:                                #mesaji aldiysan ve disconnect mesajiysa...
                    ...
                    if command !=  'X':
                        try:
                            ...
                            print("Error passing command to the client.")
                    else:
                        try:
